 ...
 */
- (nullable NSURL *)requestURLForImageURL:(nullable NSURL *)imageURL withSize:(SRGImageSize)size variant:(SRGImageVariant)variant scaling:(SRGImageScaling)scaling;
