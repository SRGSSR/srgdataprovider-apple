...
{
    NSURLRequest *URLRequest = [self requestLiveCenterVideosForVendor:vendor contentTypeFilter:contentTypeFilter eventsWithResultOnly:eventsWithResultOnly withTags:tags];
