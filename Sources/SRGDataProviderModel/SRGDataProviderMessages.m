...
NSString *SRGMessageForSkippedSegmentWithBlockingReason(SRGBlockingReason blockingReason)
{
    ...
    dispatch_once(&s_onceToken, ^{
        s_messages = @{
            ...
            @(SRGBlockingReasonJournalistic) : SRGDataProviderLocalizedString(@"The content was skipped due to journalistic restrictions.", @"A blocking reason message displayed to the user during the playback if a segment was skipped."),
