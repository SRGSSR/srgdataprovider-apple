...
NSString *SRGMessageForBlockedMediaWithBlockingReason(SRGBlockingReason blockingReason)
{
    ...
    dispatch_once(&s_onceToken, ^{
        s_messages = @{
            ...
            @(SRGBlockingReasonVPNOrProxyDetected) : SRGDataProviderLocalizedString(@"This content cannot be played while using a VPN or a proxy.", @"A blocking reason message displayed when the user is located behind a VPN or proxy."),
