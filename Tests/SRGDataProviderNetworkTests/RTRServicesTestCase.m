...
- (void)testTVPrograms
{
    ...
    [[self.dataProvider tvProgramsForVendor:SRGVendorRTR provider:SRGProgramProviderSRG channelUid:nil day:nil minimal:NO withCompletionBlock:^(NSArray<SRGProgramComposition *> * _Nullable programCompositions, NSHTTPURLResponse * _Nullable HTTPResponse, NSError * _Nullable error) {
    ...
    [[self.dataProvider tvProgramsForVendor:SRGVendorRTR provider:SRGProgramProviderThirdParty channelUid:nil day:nil minimal:NO withCompletionBlock:^(NSArray<SRGProgramComposition *> * _Nullable programCompositions, NSHTTPURLResponse * _Nullable HTTPResponse, NSError * _Nullable error) {
        XCTAssertNotNil(programCompositions);
        XCTAssertNil(error);
        [expectation2 fulfill];
    }] resume];
...
- (void)testTVScheduledLivestreams
{
    ...
    [[self.dataProvider tvScheduledLivestreamsForVendor:SRGVendorRTR signLanguageOnly:NO eventType:SRGScheduledLivestreamEventTypeAll withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage * _Nonnull page, SRGPage * _Nullable nextPage, NSHTTPURLResponse * _Nullable HTTPResponse, NSError * _Nullable error) {
        XCTAssertNotNil(medias);
        XCTAssertNil(error);
        [expectation1 fulfill];
    }] resume];
    ...
    [[self.dataProvider tvScheduledLivestreamsForVendor:SRGVendorRTR signLanguageOnly:YES eventType:SRGScheduledLivestreamEventTypeAll withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage * _Nonnull page, SRGPage * _Nullable nextPage, NSHTTPURLResponse * _Nullable HTTPResponse, NSError * _Nullable error) {
        XCTAssertNotNil(medias);
        XCTAssertNil(error);
        [expectation2 fulfill];
    }] resume];
    ...
    [[self.dataProvider tvScheduledLivestreamsForVendor:SRGVendorRTR signLanguageOnly:NO eventType:SRGScheduledLivestreamEventTypeNews withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage * _Nonnull page, SRGPage * _Nullable nextPage, NSHTTPURLResponse * _Nullable HTTPResponse, NSError * _Nullable error) {
        XCTAssertNotNil(medias);
        XCTAssertNil(error);
    ...
    [[self.dataProvider tvScheduledLivestreamsForVendor:SRGVendorRTR signLanguageOnly:NO eventType:SRGScheduledLivestreamEventTypeSport withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage * _Nonnull page, SRGPage * _Nullable nextPage, NSHTTPURLResponse * _Nullable HTTPResponse, NSError * _Nullable error) {
        XCTAssertNotNil(medias);
        XCTAssertNil(error);
...
- (void)testLiveCenterVideos
{
    ...
    [[self.dataProvider liveCenterVideosForVendor:SRGVendorRTR contentTypeFilter:SRGContentTypeFilterNone eventsWithResultOnly:YES withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage *page, SRGPage * _Nullable nextPage, NSHTTPURLResponse * _Nullable HTTPResponse, NSError * _Nullable error) {
        XCTAssertNotNil(medias);
        XCTAssertNil(error);
        [expectation1 fulfill];
    }] resume];
    ...
    [[self.dataProvider liveCenterVideosForVendor:SRGVendorRTR contentTypeFilter:SRGContentTypeFilterScheduledLivestream eventsWithResultOnly:YES withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage *page, SRGPage * _Nullable nextPage, NSHTTPURLResponse * _Nullable HTTPResponse, NSError * _Nullable error) {
        XCTAssertNotNil(medias);
        XCTAssertNil(error);
    ...
    [[self.dataProvider liveCenterVideosForVendor:SRGVendorRTR contentTypeFilter:SRGContentTypeFilterEpisode eventsWithResultOnly:YES withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage *page, SRGPage * _Nullable nextPage, NSHTTPURLResponse * _Nullable HTTPResponse, NSError * _Nullable error) {
        XCTAssertNotNil(medias);
        XCTAssertNil(error);
    ...
    [[self.dataProvider liveCenterVideosForVendor:SRGVendorRTR contentTypeFilter:SRGContentTypeFilterNone eventsWithResultOnly:NO withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage *page, SRGPage * _Nullable nextPage, NSHTTPURLResponse * _Nullable HTTPResponse, NSError * _Nullable error) {
        XCTAssertNotNil(medias);
        XCTAssertNil(error);
        [expectation4 fulfill];
    }] resume];
